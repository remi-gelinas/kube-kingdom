...
#MachineConfig: {
	...
	//       crt:
	//         type: string
	acceptedCAs?: [...null | x509.#PEMEncodedCertificate] @go(MachineAcceptedCAs,[]*x509.PEMEncodedCertificate)
...
#ClusterConfig: {
	...
	//       crt:
	//         type: string
	acceptedCAs?: [...null | x509.#PEMEncodedCertificate] @go(ClusterAcceptedCAs,[]*x509.PEMEncodedCertificate)
...
//
//docgen:alias
#AuthorizationConfigAuthorizerConfigList: [...null | #AuthorizationConfigAuthorizerConfig]
